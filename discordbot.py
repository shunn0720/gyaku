# -*- coding: utf-8 -*-
"""
逆おみくじBot（/gyaku コマンド, MCP＋GPT＋DB履歴＋1パネル維持＋押下権限制御, ボタン絵文字なし版）
"""
...
class GyakuOmikujiView(discord.ui.View):
    def __init__(self, today_omikuji: dict, invoker_id: int):
        ...
        self.today_omikuji = today_omikuji    # {user_id: result}
